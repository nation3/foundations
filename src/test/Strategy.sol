...
contract StrategyTest is DSTestPlus {
    ...
    function testSupplyRepresentingSelf() public {
        console2.log("Supply Point Epoch: %s", strategy.getSupplyPointEpoch());

        strategy._checkpoint(address1, address1);
        ...
        strategy._checkpoint(address2, address2);
        ...
        uint256 sumBalance = veToken.balanceOf(address1) + veToken.balanceOf(address2);
    ...
    function testSupplyWithIncreasedLockRepresentingSelf() public {
        console2.log("Supply Point Epoch: %s", strategy.getSupplyPointEpoch());
    ...
    function testSupplyWithTwoAddressesWithIncreasedLockRepresentingSelf() public {
        console2.log("Supply Point Epoch: %s", strategy.getSupplyPointEpoch());
    ...
    function testBalanceOfWithOneAddressRepresentingSelf() public {
        strategy._checkpoint(address1, address1);

        assertEq(strategy.balanceOf(address1), veToken.balanceOf(address1));
    }

    function testBalanceOfDoesNotGiveVotingPowerRetroactively() public {
        strategy._checkpoint(address1, address1);
    ...
    function testBalanceOfAdjustsVotingPowerForward() public {
        strategy._checkpoint(address1, address1);
    ...
    function testTotalSupplyAdjustsVotingPowerForward() public {
        strategy._checkpoint(address1, address1);
        strategy._checkpoint(address2, address2);
